...
class PerrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perro" do
    assert_difference('Perro.count') do
      post perros_url, params: { perro: { fecha_adopcion: @perro.fecha_adopcion, fecha_ingreso: @perro.fecha_ingreso, fecha_nacimiento: @perro.fecha_nacimiento, nombre: @perro.nombre } }
    end
  ...
  test "should update perro" do
    patch perro_url(@perro), params: { perro: { fecha_adopcion: @perro.fecha_adopcion, fecha_ingreso: @perro.fecha_ingreso, fecha_nacimiento: @perro.fecha_nacimiento, nombre: @perro.nombre } }
