...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { descripcion: @proveedor.descripcion, email: @proveedor.email, nombre: @proveedor.nombre, telefono: @proveedor.telefono } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { descripcion: @proveedor.descripcion, email: @proveedor.email, nombre: @proveedor.nombre, telefono: @proveedor.telefono } }
