...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference('Consultum.count') do
      post consulta_url, params: { consultum: { fecha: @consultum.fecha, tipo: @consultum.tipo } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { fecha: @consultum.fecha, tipo: @consultum.tipo } }
