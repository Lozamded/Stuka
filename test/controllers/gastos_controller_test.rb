...
class GastosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gasto" do
    assert_difference('Gasto.count') do
      post gastos_url, params: { gasto: { descripcion: @gasto.descripcion, precio: @gasto.precio } }
    end
  ...
  test "should update gasto" do
    patch gasto_url(@gasto), params: { gasto: { descripcion: @gasto.descripcion, precio: @gasto.precio } }
