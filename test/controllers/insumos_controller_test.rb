...
class InsumosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insumo" do
    assert_difference('Insumo.count') do
      post insumos_url, params: { insumo: { nombre: @insumo.nombre, precio: @insumo.precio, presentacion: @insumo.presentacion, tipo: @insumo.tipo } }
    end
  ...
  test "should update insumo" do
    patch insumo_url(@insumo), params: { insumo: { nombre: @insumo.nombre, precio: @insumo.precio, presentacion: @insumo.presentacion, tipo: @insumo.tipo } }
